...
**Create two dataframes for males and females, calculating the frequency for each height. Then combine the two dataframes back into one and plot the height distribution using a ggplot**
